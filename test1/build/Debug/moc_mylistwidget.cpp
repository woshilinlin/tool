...
QT_MOC_LITERAL(1, 13, 11), // "deletePoint"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9), // "removeRow"
QT_MOC_LITERAL(4, 36, 16), // "removeCurrentRow"
QT_MOC_LITERAL(5, 53, 3) // "row"

    },
    "MyListWidget\0deletePoint\0\0removeRow\0"
    "removeCurrentRow\0row"
};
...
void MyListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deletePoint((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->removeRow(); break;
        case 2: _t->removeCurrentRow((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyListWidget::deletePoint)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyListWidget::deletePoint(int _t1)
{
