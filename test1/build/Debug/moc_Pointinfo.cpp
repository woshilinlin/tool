...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PointInfo_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(3, 22, 12) // "deleteButton"

    },
    "PointInfo\0currentRow\0\0deleteButton"
};
...
void PointInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PointInfo::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PointInfo::currentRow)) {
                *result = 0;
                return;
            }
        }
...
void *PointInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PointInfo.stringdata0))
...
// SIGNAL 0
void PointInfo::currentRow(int _t1)
{
